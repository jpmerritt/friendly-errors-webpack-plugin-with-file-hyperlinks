...
it('Groups same module in module-not-found with 2 files', () => {
  ...
  let errorShownToUser = moduleNotFound([reduxError, reactError1, reactError2])
  expect(errorShownToUser[3]).toMatch(/react in.*\/src\/file1\.js.*\,{1}.*\/src\/file2.js/);
});
...
it('Groups same module in module-not-found with 3 files', () => {
  ...
  expect(moduleNotFound([reduxError, reactError1, reactError2, reactError3])[3]).toMatch(/react in.*\/src\/file1\.js.*\,{1}.*\/src\/file2.js.*and 1 other/);
});
...
it('Groups same module in module-not-found with 4 files', () => {
  ...
  expect(moduleNotFound([reduxError, reactError1, reactError2, reactError3, reactError4])[3]).toMatch(/react in.*\/src\/file1\.js.*\,{1}.*\/src\/file2.js.*and 2 others/)
});
